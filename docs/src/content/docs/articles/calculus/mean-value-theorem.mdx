...
<Aside type="note" title="Mean Value Theorem">
...
<Aside type="note" title="Theorem 1.2 (Fermat's Theorem)">
...
<Aside type="note" title="Theorem 1.2 (Extreme Value Theorem)">
...
<Aside type="note" title="Theorem 1.3 (Rolle's Theorem)">
